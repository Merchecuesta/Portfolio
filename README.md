...
Juego de consola estilo Hundir la Flota, desarrollado en Python. ⚔Enfrenta al jugador contra la máquina con colocación y disparos aleatorios. Ejecuta main.py para jugar desde terminal y hunde la flota enemiga.
...
¿Es tu vecino vecino? - Julio 2025
 de datos de migración interna y externa en España, utilizando herramientas modernas de Python para el procesamiento, visualización y extracción automatizada de datos
...
Asistente virtual para actividades infantiles
Desarrollo de LLM-based assistant que sugiere actividades offline para niños. Procesamiento de texto, generación de recomendaciones y análisis de preferencias

SIRP
Proyecto conjunto Ciber/FS/Data para diseñar y proponer una solución de software innovadora orientada a la protección, gestión y valor de la información del cliente.
